...
const SubmissionError = () => {
  return (
    <ErrorMessage center>
      The email address provided is already associated with a BDC account.
      For questions, please email <a href="mailto:biodatacatalyst@nhlbi.nih.gov">biodatacatalyst@nhlbi.nih.gov</a>.
    </ErrorMessage>
  );
};
...
export const JoinForm = (props) => {
  ...
  return (
    <Card {...props}>
      ...
      <CardBody>
        {wasSubmitted && error && <SubmissionError />}
        {!wasSubmitted && (
          <Fragment>
            <Paragraph>
