...
2. Go to <Link to="https://picsure.biodatacatalyst.nhlbi.nih.gov/login" className="GTM-inline-link" id="dug-cohort-link">the BDC platform where you can build cohorts across datasets for analysis</Link>.
