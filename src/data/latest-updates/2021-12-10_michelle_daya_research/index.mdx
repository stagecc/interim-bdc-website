...
researchers:
  - 
    ...
    titleAffiliation: "Researcher, University of Colorado"
    image: "./daya-michelle.jpg"
    description: >
      Michelle Daya, PhD, is a human genetics researcher, with a focus on how genetic makeup influences risk for developing common allergies such as asthma and eczema. Her research was supported in part by the BioData Catalyst Fellowship Program, which she participated in during Cohort I. For her study, Multiethnic genome-wide and HLA association study of total serum IgE level, she leveraged data from the National Heart, Lung and Blood Institute (NHLBI) Trans-Omics for Precision Medicine (TOPMed) program; the Consortium on Asthma among African-ancestry Populations in the Americas (CAAPA); and the Atopic Dermatitis Research Network (ADRN).
seo:
  title: "BioData Catalyst Used for Genomics Research on Link Between Genetic Risk and Allergic Disease"
  description: ""
...
* View her professional biography as part of the [BioData Catalyst Fellows](/about/bdc-fellows) program.
...
To learn more about BioData Catalyst, view the BioData Catalyst website or [join the community](/join-bdc).
