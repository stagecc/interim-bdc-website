...
![RECOVER Adult Cohort](./recover.png)
</div>
...
As more RECOVER data go through NIH's normative process for sharing de-identified research results, they will also be made available in BDC to authorized researchers. Those interested in learning more about RECOVER data in BDC, reading the RECOVER data release notes, exploring aggregated study information about the data, or accessing individual-level data will find more information and instructions on the [RECOVER @ BDC webpage](/about/research-communities/#recover).

CHANGED: For more information about the RECOVER Initiative, visit this website: [https://recovercovid.org](https://recovercovid.org/).

To stay up to date on RECOVER data in BDC and other BDC news, [join the BDC community](/join-bdc).

*Previously, a de-identified data file of RECOVER data from the JAMA publication, "Development of a Definition of Postacute Sequelae of SARS-CoV-2 Infection," published on May 25, 2023, [was made available](https://recovercovid.org/data) to to those who requested and received data access.