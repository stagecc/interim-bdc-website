...
import { PageContent, StickyLeftMenu } from "../../components/layout"
...
In addition to tools, applications, and workflows, BDC provides access to NHLBI datasets, allows researchers to bring their own data, and offers secure collaboration workspaces. 
