...
> 
  ...
  - **To explore hosted data or conduct a feasibility study,** visit
    the [Explore Data in BDC webpage](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/explore-data).
  
  - **To build cohorts for analyses with BDC data,** visit
    the [Analyze Data webpage](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/analyze-data).\*
  
  - **To analyze BDC data, data you bring to BDC (Bring Your Own Data), or any combination**
    in a secure BDC workspace, learn more on the [Analyze Data webpage](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/analyze-data).\*
  
  - **To share scientific data and use BDC as a scientific data repository**, visit
    the [Share Data webpage](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/share-data).
  ...
  - **Learn about [Usage Costs](https://biodatacatalyst.nhlbi.nih.gov/user-resources/usage-costs)**
    [(cloud credits)](https://biodatacatalyst.nhlbi.nih.gov/user-resources/usage-costs),
  ...
  - Read the [**Terms of Use & Policies**](https://biodatacatalyst.nhlbi.nih.gov/user-resources/usage-terms)
  
  - Use links on [**the Support webpage**](https://biodatacatalyst.nhlbi.nih.gov/help-support/support),
  ...
  the [Contact Us webpage](https://biodatacatalyst.nhlbi.nih.gov/help-support/contact) and submit the online form. Select the “New to BDC and need help getting started” type (dropdown option).
