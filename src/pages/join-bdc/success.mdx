...
<PageContent title="Welcome to the BDC Community!"> 
  ...
  \* _Indicates that BDC users must have eRA Commons credentials and/or approved data access requests (DARs). See the “Requirements for Accessing BDC Hosted Data” section on the [Explore Data in BDC webpage](/use-bdc/explore-data)._
  ...
  - Read the [**Terms of Use & Policies**](/user-resources/terms-of-use/)
  
  - Use links on [**the Support webpage**](/help-and-support/support),
  ...
  the [Contact Us webpage](/help-and-support/contact-us) and submit the online form. Select the “New to BDC and need help getting started” type (dropdown option).
