...
[Learn more about joining the BDC community and complete the form](https://biodatacatalyst.nhlbi.nih.gov/join-bdc).
...
Current and potential users of the ecosystem and others are encouraged to provide their input by going to the [Contact Us](https://biodatacatalyst.nhlbi.nih.gov/help-support/contact) webpage and selecting the "Provide Feedback" type (dropdown option). User feedback weighs heavily into the decisions about enhancements to the ecosystem.

User and community feedback received since BDC's inception has led to the incorporation of different functionalities and improvements in the way BDC provides user support. In its early stages, NHLBI and ecosystem developers depended on input from an External Expert Panel and initial users. In 2020, NHLBI ensured the receipt of more valuable insights by supporting [three cohorts of fellowships over three years. NHLBI funded over 45 early-career researchers](https://biodatacatalyst.nhlbi.nih.gov/about/overview/bdc-fellows) in researching novel and innovative data science and data-focused research problems while benefiting from their feedback on improving BDC and its users' experiences.

Today, BDC still welcomes feedback from participants in [Fellowship Collaborations](https://biodatacatalyst.nhlbi.nih.gov/about/key-collaborations) and encourages all users and potential users to provide input to help in our effort to meet users' needs.
...
> The BioData Catalyst Coordinating Center ([Renaissance Computing Institute (RENCI)](https://renci.org/) at the University of North Carolina-Chapel Hill) manages operations within the BDC developer consortium and ensures the ecosystem grows in alignment with NHLBI's strategic vision.

> The BDC Data Management Core (DMC) ([Research Triangle Institute International](https://www.rti.org/)) supports the ingestion of heart, lung, blood, and sleep data into BDC to facilitate its availability for reuse by the researcher community. It is responsible for streamlining processes for data ingestion into the ecosystem, aiming to facilitate efficient data integration through the development of procedures and tools related to standards and data harmonization.
...
*Indicates that BDC users must have eRA Commons credentials. See the "Requirements for Accessing BDC Hosted Data" section on the [Explore Data in BDC webpage](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/explore-data).
...
**See BDC's [Key Collaborations](https://biodatacatalyst.nhlbi.nih.gov/about/key-collaborations)**
