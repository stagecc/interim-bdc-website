...
import { FloatingVideoWrapper } from "../../components/layout"
...
Not all the data from these research communities are broadly available in the ecosystem; however, BDC regularly adds data from these communities and other studies for broad research use. 
...
<FloatingVideoWrapper placement="right">
  <VideoPlayer url="https://youtu.be/gHeiMYOwPD8" controls={true} />
  <VideoPlayer url="https://youtu.be/pJT9fczTU2o" controls={true} />
...
The [RECOVER Data Release Notes](https://bdcatalyst.gitbook.io/biodata-catalyst-documentation/written-documentation/nih-recover-release-notes) provide more information about the RECOVER data in BDC. They include the de-identification protocols, information about the data in each release, and information for authoring publications. Also, there are links to the RECOVER Data Dictionaries (REDCap Codebooks).

Currently, BDC hosts two RECOVER datasets. The adult observational cohort study represents over 15,200 participants attending more than 121,000 study visits at 83 enrolling sites. The pediatric observational cohort study dataset consists of survey and laboratory results from more than 24,000 young adults, children, infants, and their caregivers who participated in more than 62,000 study visits at 115 enrolling sites.
...
Other major extramural NHLBI scientific initiatives with large amounts of human subject data interested in collaborating with BDC should contact the BDC Data Management Core (DMC) using the [Contact Us webpage](/help-and-support/contact-us) and selecting the "Interest in Collaborating with BDC" type (dropdown option).

Analysis of data in BDC from the above communities requires [eRA Commons credentials](https://public.era.nih.gov/commonsplus/public/login.era?TARGET=https%3A%2F%2Fpublic.era.nih.gov%3A443%2Fcommons) and approved [data access requests](https://dbgap.ncbi.nlm.nih.gov/aa/wga.cgi?page=login) (DARs) for each dataset from the [NIH Database of Genotypes and Phenotypes (dbGaP)](https://www.ncbi.nlm.nih.gov/gap/). For more information, visit the [Explore Data webpage](/use-bdc/explore-data).
