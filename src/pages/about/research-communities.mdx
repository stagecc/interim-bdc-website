...
Analysis of data in BDC from the above communities requires eRA Commons credentials and approved data access requests (DARs) for each dataset from the NIH Database of Genotypes and Phenotypes (dbGaP). For more information, visit the Explore Data webpage.
