...
_If you are using a Terra Workspace, please scroll to the bottom of this webpage for more information. Read more about [the differences between BDC’s standard workspaces BDC Powered by Seven Bridges) and those provided by BDC Powered by Terra](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/analyze-data/bdc-workspaces)_.
