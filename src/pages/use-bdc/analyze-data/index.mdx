...
BDC workspaces offer private, secure environments for running analyses at scale. BDC also has RStudio, Jupyterlab, and SAS Notebooks built directly into the platform.
...
If you are using a Terra Workspace, please scroll to the bottom of this webpage for more information. Read more about [the differences between BDC's standard workspaces (BDC Powered by Seven Bridges) and those provided by BDC Powered by Terra](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/analyze-data/bdc-workspaces).

## Utilize Analysis Tools

BDC workspaces have tools and features for performing common analyses of genomics, transcriptomics, metabolomics, and proteomics data. Tools and workflows are written in the Common Workflow Language (CWL) to ensure reproducibility and portability. The platform offers several options for researchers to run single-variant and multiple-variant association tests, including a cloud-optimized version of the Genesis R package. The Annotation Explorer offers functionality for pre-association testing and post-association testing steps, including the ability to create variant aggregations. Tool developers and researchers can also create their own CWL tools on the platform by [importing a Dockstore App](https://sb-biodatacatalyst.readme.io/docs/import-a-dockstore-app) and [following](https://bdcatalyst.gitbook.io/biodata-catalyst-documentation/written-documentation/community-tools-and-integration-1/bring-your-own-tool-s-to-biodata-catalyst) step-by-step guides.

## Utilize Analysis Tools

BDC workspaces have tools and features for performing multiple-variant and single-variant association studies, including Annotation Explorer for variant aggregations and cloud-optimized Genesis R package workflows in Common Workflow Language (CWL). Researchers can also [import a Dockstore App](https://sb-biodatacatalyst.readme.io/docs/import-a-dockstore-app) and [bring their own tools and workflows](https://bdcatalyst.gitbook.io/biodata-catalyst-documentation/written-documentation/community-tools-and-integration-1/bring-your-own-tool-s-to-biodata-catalyst).

## Bring Your Own Data (BYOD)

As described in the [BDC Data Use Policy](https://biodatacatalyst.nhlbi.nih.gov/user-resources/usage-terms), researchers can upload data to a BDC workspace to share data with their collaborators via a consortium sharing model (account required; see [Prepare to Analyze Data](#prepare-to-analyze-data) above) if they have the appropriate approvals, provided researchers do not violate the terms of their Data Use Agreements, Limitations, or Institutional Review Board policies and guidelines.

Data can be uploaded from local storage or an HTTP(S)/FTP server or import it from cloud storage. Read "[Upload your data" for more information.](https://sb-biodatacatalyst.readme.io/docs/upload-to-the-platform).
...
<NextStepsCard>
  ...
  **Consider Using BDC as a [Data Repository (Share Data)](https://biodatacatalyst.nhlbi.nih.gov/use-bdc/share-data)**
</NextStepsCard>
