...
<Link to="https://accounts.sb.biodatacatalyst.nhlbi.nih.gov/auth/login" className="GTM-inline-link" id="">BDC workspaces</Link> are equipped with a breadth of pre-installed tools designed to perform complex bioinformatics analyses of both phenotypic and multi-omics data, including genomics, transcriptomics, metabolomics, proteomics, and imaging. BDC workspaces include the following features:
