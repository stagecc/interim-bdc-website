...
<PageContent title="Home" hideTitle>
  ...
  >
    ...
    <Paragraph center style={{ fontSize: '80%' }}>
      _Semantic search provided by Dug. <Link to="https://bdcatalyst.gitbook.io/biodata-catalyst-documentation/written-documentation/data-access/submitting-a-dbgap-data-access-request">Learn more about Dug here</Link>_.
    </Paragraph>
